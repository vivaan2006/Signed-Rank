...
print(len(control_data["ID"]))
print(len(control_data["Age_Control"]))
print(len(control_data["Race_Control"]))
print(len(control_data["Smoker_Control"]))
print(len(control_data["Propensity_Score_Control"]))
